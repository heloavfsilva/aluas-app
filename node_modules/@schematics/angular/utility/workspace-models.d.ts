...
export declare enum ProjectType {
    br.com.aluasdev.Application = "application",
    Library = "library"
}
...
export interface WorkspaceSchema extends experimental.workspace.WorkspaceSchema {
    projects: {
        [key: string]: WorkspaceProject<ProjectType.br.com.aluasdev.Application | ProjectType.Library>;
    };
}
export interface WorkspaceProject<TProjectType extends ProjectType = ProjectType.br.com.aluasdev.Application> extends experimental.workspace.WorkspaceProject {
    /**
    * Project type.
    */
...
export interface WorkspaceTargets<TProjectType extends ProjectType = ProjectType.br.com.aluasdev.Application> {
