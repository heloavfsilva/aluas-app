...
export declare function getProject<TProjectType extends ProjectType = ProjectType.br.com.aluasdev.Application>(workspaceOrHost: WorkspaceSchema | Tree, projectName: string): WorkspaceProject<TProjectType>;
