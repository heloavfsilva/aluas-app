...
export declare function addProjectToWorkspace<TProjectType extends ProjectType = ProjectType.br.com.aluasdev.Application>(workspace: WorkspaceSchema, name: string, project: WorkspaceProject<TProjectType>): Rule;
